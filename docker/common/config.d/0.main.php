...
return [
    ...
    'themes.active' => "SantaLuziaMG",

    'app.lcode' => 'pt_BR',
    #'homeHeader.banner' => 'img/banner-paulo-gustavo.png',
    #'homeHeader.bannerLink' => 'https://mapacultural.gov.br/files/agent/7/caderno-de-orientacoes-pcac-27-09-2023.pdf',
    #'homeHeader.downloadableLink' => true,

    #'homeHeader.secondBanner' => 'img/banner-tributacao.png',
    #'homeHeader.secondBannerLink' => 'https://mapacultural.gov.br/files/project/1278/parecer-impostos.pdf',
